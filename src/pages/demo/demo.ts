...
export class DemoPage implements OnInit {
  ...
  public changeCamera() {
    ...
    this.getDeviceId(this.deviceId).then(deviId => {
      this.deviceId = deviId;
      // this.ngRenderer.removeChild(this.elementRef.nativeElement,this.elementRef.nativeElement.querySelector('video'));
      // this.ngRenderer.removeChild(this.elementRef.nativeElement,this.elementRef.nativeElement.querySelector('canvas'));
      this.createARParameters();
      this.appendStatisticsScreen(this.content);
    })
  }
 ...
 */
  ...
  private createARParameters() {
    ...
    let successFn = (arScene: ARThreeScene, arController, arCamera) => {
      ...
      console.log("elref", this.elementRef.nativeElement.querySelector('video'));
